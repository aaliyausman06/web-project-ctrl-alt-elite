...
try {
    $stmt = $conn->prepare("
        ...
        WHERE p.published = 1 AND p.type = 'Foundation'
    ");
    $stmt->execute();
    $programs = $stmt->fetchAll(PDO::FETCH_ASSOC);

    if (empty($programs)) {
        throw new Exception("No foundation programs found in the database.");
    }
...
<head>
    ...
    <title>Foundation Courses</title>
...
<section class="header"> 
    ...
    <header>
        ...
        <nav>
            <a href="index.html">Home</a> / <a href="foundation-courses.php">Foundation Courses</a>
        </nav>
    </header>
    </section>
    ...
    <main>
        ...
        <?php else: ?>
            <p>No foundation programs available at the moment.</p>
        <?php endif; ?>
    </main>
